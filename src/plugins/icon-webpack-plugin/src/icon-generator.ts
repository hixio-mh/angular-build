...
import { IconOptions, IconDesign, IconResult, IconFileInfo } from './models';
...
export class IconGenerator {
  ...
  private prepareOfflineOptions(imageFileStream: Buffer, iconOptions: IconOptions): IconOptions {
