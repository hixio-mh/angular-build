...
export function statsToString(json: any, statsConfig: any): string {
...
export function statsWarningsToString(json: any, statsConfig: any): string {
    ...
    const s = json.warnings.map((warning: any) => y(`WARNING in ${warning}`)).join('\n\n');
...
export function statsErrorsToString(json: any, statsConfig: any): string {
    ...
    const s = json.errors.map((error: any) => r(`ERROR in ${error}`)).join('\n');
