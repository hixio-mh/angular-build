...
Another cli build tool and [Angular CLI](https://github.com/angular/angular-cli) architect builder plugin for building [Angular](https://github.com/angular/angular) application and library projects.
